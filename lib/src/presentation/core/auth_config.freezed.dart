...
mixin _$AuthConfig {
  ...
  ButtonConfig get microsoftButton;
...
abstract class $AuthConfigCopyWith<$Res> {
  ...
  $ButtonConfigCopyWith<$Res> get microsoftButton;
}
...
class _$AuthConfigCopyWithImpl<$Res> implements $AuthConfigCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object microsoftButton = freezed,
    ...
    return _then(_value.copyWith(
      ...
      microsoftButton: microsoftButton == freezed
          ? _value.microsoftButton
          : microsoftButton as ButtonConfig,
  ...
  @override
  $ButtonConfigCopyWith<$Res> get microsoftButton {
    if (_value.microsoftButton == null) {
      return null;
    }
    return $ButtonConfigCopyWith<$Res>(_value.microsoftButton, (value) {
      return _then(_value.copyWith(microsoftButton: value));
    });
  }
}
...
class _$_AuthConfig with DiagnosticableTreeMixin implements _AuthConfig {
  ...
  @override
  final ButtonConfig microsoftButton;
  @override
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthConfig(title: $title, signInButton: $signInButton, registerButton: $registerButton, anonymousButton: $anonymousButton, googleButton: $googleButton, appleButton: $appleButton, githubButton: $githubButton, twitterButton: $twitterButton, microsoftButton: $microsoftButton, emailTextField: $emailTextField, passwordTextField: $passwordTextField)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('microsoftButton', microsoftButton))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _AuthConfig &&
            ...
            (identical(other.microsoftButton, microsoftButton) ||
                const DeepCollectionEquality()
                    .equals(other.microsoftButton, microsoftButton)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(microsoftButton) ^
